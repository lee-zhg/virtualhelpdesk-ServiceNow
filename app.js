  ...
  conversation.message(payload, function (err, data) {
    ...
    if (runDiscovery) {
      ...
      if (data.context.newticket & !(data.context.severity === undefined)) {
        ...
        callSNOW(description, data.context.severity).then(function (body) {
          ...
          console.error(error);
          console.error("Failed when calling ServiceNow");
        });
 ...
 */
function callSNOW(description, severity) {
  ...
  return new Promise((resolve, reject) => {
    ...
    */
    ...
    var maximo_rest_body = '{ \
      ...
      console.log('Authorization: ' + process.env.SNOW_AUTH);
      console.log('CONTENT-TYPE:' + process.env.SNOW_CONTEXT_TYPE)
      console.log('Accept: ' + process.env.SNOW_CONTEXT_TYPE)
